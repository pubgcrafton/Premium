...
class HelpMod(loader.Module):
    ...
    strings = {
        ...
        "request_join": "You requested link for Premium support chat",
        "core_notice": (
    ...
    strings_ru = {
        ...
        "request_join": "Вы запросили ссылку на чат помощи Premium",
        "core_notice": (
    ...
    strings_tr = {
        ...
        "request_join": "Premium Destek sohbetinin davet bağlantısını istediniz",
        "core_notice": (
    ...
    async def help(self, message: Message):
        ...
        for mod in self.allmodules.modules:
            ...
            if core:
                ...
                emoji = self.config["premium_emoji"]
            else:
    ...
    @loader.command(
        ru_doc="Показать ссылку на чат помощи Premium",
        de_doc="Zeige den Link zum Premium-Hilfe-Chat",
        tr_doc="Premium yardım sohbetinin bağlantısını göster",
        uz_doc="Premium Userbot yordam suhbatining havolasini ko'rsatish",
        ...
        es_doc="Mostrar enlace al chat de ayuda de Premium",
    )
    async def support(self, message):
        """Get link of Premium support chat"""
        if message.out:
