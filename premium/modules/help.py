...
class HelpMod(loader.Module):
    ...
    strings = {
        ...
        "request_join": "Siz Premium qo'llab-quvvatlash suhbatiga havolani so'radingiz",
    }
    ...
    strings_ru = {
        ...
        "request_join": "Вы запросили ссылку на чат помощи Premium userbot",
    }
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "premium_emoji",
                "🧑‍🎤",
                lambda: "Premium userbot modul o'qi",
                validator=loader.validators.String(length=1),
            ),
            loader.ConfigValue(
                "tekis_emoji",
    ...
    @loader.command(ru_doc="Показать ссылку на чат помощи Premium")
    async def support(self, message):
        """Premium  qo'llab-quvvatlash chati bilan boğlaning"""
        if message.out:
