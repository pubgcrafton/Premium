...
class Translations(loader.Module):
    ...
    strings_uz = {
        ...
        "invoke_failed": (
            "<b>🚫 Modulni ishga tushirish muvaffaqiyatsiz bo'ldi! Batafsil ma'lumotlar"
            " jurnallarda</b>"
        ),
        "show_inline_cmds": "📄 Barcha mavjud inline buyruqlarni ko'rsatish",
    ...
    @loader.command(
        ...
        uz_doc="[til] - Standart tilni o'zgartirish",
    ...
    async def dllangpackcmd(self, message: Message):
        """[link to a langpack | empty to remove] - Change Premium translate pack (external)
        """
        args = utils.get_args_raw(message)
