...
@loader.tds
class PremiumSettingsMod(loader.Module):
    """Advanced settings for Premium Userbot"""
    ...
    strings = {
        ...
        "inline_settings": "⚙️ <b>Here you can configure your Premium settings</b>",
        "confirm_update": (
        ...
        "nonick_warning": (
            ...
            "You may get muted in Premium chats. Change prefix or "
            "disable NoNick!"
        ),
        "reply_required": (
        ...
        "deauth_confirm": (
            "⚠️ <b>This action will fully remove Premium from this account and can't be"
            " reverted!</b>\n\n<i>- Premium chats will be removed\n- Session will be"
            " terminated and removed\n- Premium inline bot will be removed</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>Are you really sure you want to delete Premium?</b>"
        ),
        "deauth_yes": "I'm sure",
        ...
        "uninstall": "😢 <b>Uninstalling Premium...</b>",
        "uninstalled": (
            "😢 <b>Premium uninstalled. Web interface is still active, you can add another"
            " account</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>This command gives access to your Premium web interface. It's not"
        ...
        "opening_tunnel": "🔁 <b>Opening tunnel to Premium web interface...</b>",
        "tunnel_opened": "🎉 <b>Tunnel opened. This link is valid for about 1 hour</b>",
        "web_btn": "🌍 Web interface",
        "btn_yes": "🚸 Open anyway",
        "btn_no": "🔻 Cancel",
        "lavhost_web": (
            "✌️ <b>This link leads to your Premium web interface on lavHost</b>\n\n<i>💡"
    ...
    strings_ru = {
        ...
        "inline_settings": "⚙️ <b>Здесь можно управлять настройками Premium</b>",
        ...
        "_cls_doc": "Дополнительные настройки Premium",
        "nonick_warning": (
            "Внимание! Ты включил NoNick со стандартным префиксом! "
            "Тебя могут замьютить в чатах Premium. Измени префикс или "
        ...
        "deauth_confirm": (
            "⚠️ <b>Это действие полностью удалит Premium с этого аккаунта! Его нельзя"
            " отменить</b>\n\n<i>- Все чаты, связанные с Premium будут удалены\n- Сессия"
            " Premium будет сброшена\n- Инлайн бот Premium будет удален</i>"
        ),
        "deauth_confirm_step2": "⚠️ <b>Ты точно уверен, что хочешь удалить Premium?</b>",
        "deauth_yes": "Я уверен",
        ...
        "uninstall": "😢 <b>Удаляю Premium...</b>",
        "uninstalled": (
            "😢 <b>Premium удалена. Веб-интерфейс все еще активен, можно добавить другие"
            " аккаунты!</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>Эта команда дает доступ к веб-интерфейсу Premium. Ее выполнение в"
        ...
        "opening_tunnel": "🔁 <b>Открываю тоннель к веб-интерфейсу Premium...</b>",
        "tunnel_opened": (
        ...
        "btn_no": "🔻 Закрыть",
        "lavhost_web": (
            "✌️ <b>По этой ссылке ты попадешь в веб-интерфейс Premium на"
    ...
    strings_de = {
        ...
        "inline_settings": (
            "⚙️ <b>Hier können Sie Ihre Premium-Einstellungen verwalten</b>"
        ),
        "confirm_update": (
        ...
        "_cls_doc": "Erweiterte Premium-Einstellungen",
        "nonick_warning": (
            "Achtung! Sie haben NoNick mit dem Standard-Präfix eingefügt!Sie sind"
            " möglicherweise in Premium-Chats stummgeschaltet. Ändern Sie das Präfix oder"
        ...
        "deauth_confirm": (
            "⚠️ <b>Diese Aktion wird Premium vollständig von diesem Konto entfernen! Er"
            " kann nichtAbbrechen</b>\n\n<i>- Alle Premium-bezogenen Chats werden"
            " gelöscht\n- SitzungPremium wird zurückgesetzt\n- Premium Inline-Bot wird"
            " gelöscht</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>Sind Sie sicher, dass Sie Premium deinstallieren möchten?</b>"
        ),
        ...
        "uninstall": "😢 <b>Premium wird deinstalliert...</b>",
        "uninstalled": (
            "😢 <b>Premium wurde entfernt. Die Weboberfläche ist noch aktiv, andere können"
        ...
        "privacy_leak": (
            "⚠️ <b>Dieser Befehl ermöglicht den Zugriff auf die Premium-Weboberfläche."
        ...
        "opening_tunnel": "🔁 <b>Öffne einen Tunnel zur Premium-Weboberfläche...</b>",
        "tunnel_opened": (
        ...
        "btn_no": "🔻Schließen",
        "lavhost_web": (
            "✌️ <b>Dieser Link führt Sie zur Premium-Weboberfläche auf"
    ...
    strings_tr = {
        ...
        "inline_settings": "⚙️ <b>Buradan Premium ayarlarınızı yönetebilirsiniz</b>",
        "confirm_update": (
        ...
        "_cls_doc": "Gelişmiş Premium Ayarları",
        "nonick_warning": (
            "Dikkat! NoNick'i standart önekle eklediniz!"
            "Premium sohbetlerinde sesiniz kapatılmış olabilir. Ön eki değiştirin veya "
        ...
        "deauth_confirm": (
            "⚠️ <b>Bu işlem Premium'yı bu hesaptan tamamen kaldıracak! Yapamaz"
            "iptal</b>\n\n<i>- Premium ile ilgili tüm sohbetler silinecek\n- Oturum"
            " Premium sıfırlanacak\n- Premium'nın satır içi botu silinecek</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>Premium'yı kaldırmak istediğinizden emin misiniz?</b>"
        ),
        "deauth_yes": "Eminim",
        ...
        "uninstall": "😢 <b>Premium'yı Kaldırılıyor...</b>",
        "uninstalled": (
            "😢 <b>Premium kaldırıldı. Web arayüzü hala aktif, başkaları eklenebilir"
            "hesaplar!</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>Bu komut, Premium web arayüzüne erişim sağlar. YürütülmesiGenel"
        ...
        "privacy_leak_nowarn": (
            "⚠️ <b>Bu komut, Premium web arayüzüne erişim sağlar. Yürütülmesi"
    ...
    strings_uz = {
        ...
        "inline_settings": (
            "⚙️ <b>Bu yerda siz Premium Userbot sozlamalaringizni boshqarishingiz mumkin</b>"
        ),
        "confirm_update": (
        ...
        "_cls_doc": "Kengaytirilgan Premium Userbot sozlamalari",
        "nonick_warning": (
            "Diqqat! NoNickni standart prefiks bilan kiritdingiz! Premium Userbot chatlarida"
        ...
        "deauth_confirm": (
            "⚠️ <b>Bu amal Premium Userbotni ushbu hisobdan butunlay olib tashlaydi! U qila"
            " olmaydi. Bekor qilish</b>\n\n<i>- Premium Userbot bilan bog'liq barcha chatlar"
            " o'chiriladi\n- Sessiyada Premium Userbot qayta tiklanadi\n- Premium Userbotning ichki boti"
            " o'chiriladi</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>Haqiqatan ham Premium Userbotni oʻchirib tashlamoqchimisiz?</b>"
        ),
        ...
        "uninstall": "😢 <b>Premium Userbot o'chirilmoqda...</b>",
        "uninstalled": (
            "😢 <b>Premium Userbot oʻchirildi. Veb-interfeys hali ham faol, boshqa hisoblarni qoʻshish"
            " mumkin!</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>Ushbu buyruq Premium Userbot veb-interfeysiga kirish imkonini beradi. Uning"
        ...
        "opening_tunnel": "🔁 <b>Premium Userbot veb-interfeysiga tunnel ochilmoqda...</b>",
        "tunnel_opened": (
        ...
        "btn_no": "🔻 Yopish",
        "lavhost_web": (
            "✌️ <b>Ushbu havola sizni Premium Userbot veb-interfeysiga olib boradi"
    ...
    strings_ja = {
        ...
        "inline_settings": "⚙️ <b>ここで Premium の設定を管理できます</b>",
        ...
        "nonick_warning": (
            ...
            "Premium Chat でミュートすることができます。プレフィックスを変更するか, "
        ...
        "deauth_confirm": (
            "⚠️ <b>このアクションにより, このアカウントから Premium が完全に削除されます! 彼は削除できません"
            "キャンセル</b>\n\n<i>- Premium に関連するすべてのチャットが削除されます\n- セッション"
            "ヒッカはリセットされます\n- ヒッカのインライン ボットは削除されます</i>"
        ),
        "deauth_confirm_step2": "⚠️ <b>Premium をアンインストールしてもよろしいですか?</b>",
        "deauth_yes": "確かに",
        "deauth_no_1": "わからない",
        "deauth_no_2": "わかりません",
        "deauth_no_3": "いいえ",
        ...
        "uninstall": "😢 <b>Premium をアンインストールしています...</b>",
        "uninstalled": (
            "😢 <b>Premium' は廃止されました。Web インターフェースはまだアクティブです。その他アカウントを追加できます!</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>このコマンドは, Premium Web インターフェイスへのアクセスを提供します。その実行"
        ...
        "btn_no": "閉じる",
        "lavhost_web": (
            "✌️ <b>このリンクをクリックすると, Premium Web インターフェイス lvHost に移動します</b>\n\n<i>💡"
    ...
    strings_kr = {
        ...
        "inline_settings": "⚙️ <b>여기에서 Premium 설정을 관리할 수 있습니다.</b>",
        ...
        "_cls_doc": "고급 Premium 설정",
        "nonick_warning": (
            "주의! 표준 접두사에 NoNick을 포함했습니다!Premium 채팅에서 음소거할 수 있습니다. 접두사를 변경하거나 글로벌 노닉 꺼!"
        ),
        "reply_required": (
        ...
        "deauth_confirm": (
            "⚠️ <b>이 작업은 이 계정에서 Premium를 완전히 제거합니다! 그는 할 수 없습니다."
            "취소</b>\n\n<i>- Premium와 관련된 모든 채팅이 삭제됩니다\n- 세션"
            " Premium가 재설정됩니다\n- Premium의 인라인 봇이 제거됩니다</i>"
        ),
        "deauth_confirm_step2": "⚠️ <b>Premium를 제거하시겠습니까?</b>",
        "deauth_yes": "확실합니다",
        ...
        "uninstalling": "😢 <b>Premium 제거 중...</b>",
        "uninstalled": (
            "😢 <b>Premium'는 더 이상 사용되지 않습니다. 웹 인터페이스는 여전히 활성화되어 있습니다. 계정을 추가할 수 있습니다!</b>"
        ),
        ...
        "privacy_leak": (
            "⚠️ <b>이 명령은 Premium 웹 인터페이스에 대한 액세스를 제공합니다. 실행"
        ...
        "btn_no": " 닫기",
        "lavhost_web": (
            "✌️ <b>이 링크는 Premium 웹 인터페이스 lvHost</b>로 이동합니다.\n\n<i>💡"
    ...
    strings_ar = {
        ...
        "inline_settings": "⚙️ <b> هنا يمكنك إدارة إعدادات Premium </b>",
        ...
        "_cls_doc": "إعدادات Premium المتقدمة",
        "nonick_warning": (
            "تنبيه! لقد قمت بتضمين NoNick مع البادئة القياسية!"
            "يمكن كتم ص, تك في Premium Chat. قم بتغيير البادئة أ, "
        ...
        "deauth_confirm": (
            "⚠️ <b> سيؤدي هذا الإجراء إلى إزالة Premium تمامًا من هذا الحساب! لا يمكنه"
            " ذلكإلغاء </b>\n\n<i> - سيتم حذف كافة الدردشات المتعلقة بهيكا\n-"
            " الجلسةستتم إعادة تعيين Premium\n- ستتم إزالة برنامج Premium المضمن </i>"
        ),
        "deauth_confirm_step2": "⚠️ <b> هل أنت متأكد من أنك تريد إزالة Premium؟ </b>",
        ...
        "uninstalling": "😢 <b> إزالة Premium ... </b>",
        "uninstalled": (
            "<b>تم إهمال  Premium. , اجهة ال, يب لا تزال نشطة ,  , البعض الآخر"
        ...
        "privacy_leak": (
            "⚠️ <b> ي, فر هذا الأمر ال, ص, ل إلى , اجهة , يب Premium. تنفيذه"
        ...
        "btn_no": "إغلاق",
        "lavhost_web": (
            "✌️ <b> سينقلك هذا الارتباط إلى , اجهة , يب Premium lvHost </b>\n\n<i> 💡"
    ...
    strings_es = {
        ...
        "inline_settings": (
            "⚙️ <b>Aquí puedes administrar la configuración de Premium</b>"
        ),
        ...
        "_cls_doc": "Configuración avanzada de Premium",
        "nonick_warning": (
            "¡Atención! ¡Has incluido NoNick con el prefijo estándar!"
            "Puedes silenciarte en Premium Chat. Cambia el prefijo o "
        ...
        "deauth_confirm": (
            "⚠️ <b>¡Esta acción eliminará completamente a Premium de esta cuenta! Él no"
            " puedeCancelar</b>\n\n<i>- Se eliminarán todos los chats relacionados con"
            " Premium\n- Sesión Premium se reiniciará\n- El bot en línea de Premium se"
            " eliminará</i>"
        ),
        "deauth_confirm_step2": (
            "⚠️ <b>¿Está seguro de que desea desinstalar Premium?</b>"
        ),
        ...
        "uninstall": "😢 <b>Desinstalando Premium...</b>",
        "uninstalled": (
            "😢 <b>Premium' ha quedado obsoleto. La interfaz web todavía está activa,"
        ...
        "privacy_leak": (
            "⚠️ <b>Este comando proporciona acceso a la interfaz web de Premium. Su"
        ...
        "btn_no": "Cerrar",
        "lavhost_web": (
            "✌️ <b>Este enlace lo llevará a la interfaz web de Premium lvHost</b>\n\n<i>💡"
    ...
    @loader.owner
    @loader.command(
        ru_doc="Удалить Premium",
        de_doc="Premium deinstallieren",
        tr_doc="Premium'yı kaldır",
        uz_doc="Premium Userbotni o'chirish",
        hi_doc="हिक्का को अनइंस्टॉल करें",
        ja_doc="Premiumをアンインストールします",
        kr_doc="Premium를 제거합니다",
        ar_doc="إلغاء تثبيت هيكا",
        es_doc="Desinstalar Premium",
    )
    async def uninstall_premium(self, message: Message):
        """Uninstall Premium"""
    ...
    @loader.owner
    @loader.command(
        ru_doc="Открыть тоннель к веб-интерфейсу Premium",
        de_doc="Öffne einen Tunnel zum Premium Webinterface",
        tr_doc="Premium Web Arayüzüne bir tünel aç",
        uz_doc="Premium Userbot veb-interfeysi uchun tunel ochish",
        hi_doc="Premium वेब इंटरफ़ेस के लिए ट्यूनल खोलें",
        ja_doc="Premium Webインターフェイスにトンネルを開く",
        kr_doc="Premium 웹 인터페이스에 터널 열기",
        ar_doc="افتح نفقًا إلى واجهة Premium الويب",
        es_doc="Abrir un túnel al interfaz web de Premium",
    )
    async def weburl(self, message: Message, force: bool = False):
        """Opens web tunnel to your Premium web interface"""
        if "LAVHOST" in os.environ:
            form = await self.inline.form(
                ...
                reply_markup={
                    ...
                    "url": await main.premium.web.get_url(proxy_pass=False),
                },
        ...
        url = await main.premium.web.get_url(proxy_pass=True)
    ...
    async def invoke(self, message: Message):
        ...
        if module == "core":
            if method == "clear_entity_cache":
                result = (
                    f"Dropped {len(self._client._premium_entity_cache)} cache records"
                )
                self._client._premium_entity_cache = {}
            elif method == "clear_fulluser_cache":
                result = (
                    f"Dropped {len(self._client._premium_fulluser_cache)} cache records"
                )
                self._client._premium_fulluser_cache = {}
            elif method == "clear_fullchannel_cache":
                result = (
                    f"Dropped {len(self._client._premium_fullchannel_cache)} cache"
                    " records"
                )
                self._client._premium_fullchannel_cache = {}
            elif method == "clear_perms_cache":
                result = f"Dropped {len(self._client._premium_perms_cache)} cache records"
                self._client._premium_perms_cache = {}
            elif method == "clear_cache":
                result = (
                    f"Dropped {len(self._client._premium_entity_cache)} entity cache"
                    " records\nDropped"
                    f" {len(self._client._premium_fulluser_cache)} fulluser cache"
                    " records\nDropped"
                    f" {len(self._client._premium_fullchannel_cache)} fullchannel cache"
                    " records"
                )
                self._client._premium_entity_cache = {}
                self._client._premium_fulluser_cache = {}
                ...
                result = (
                    "Entity cache:"
                    f" {len(self._client._premium_entity_cache)} records\nFulluser cache:"
                    f" {len(self._client._premium_fulluser_cache)} records\nFullchannel"
                    f" cache: {len(self._client._premium_fullchannel_cache)} records"
                )
