...
class LoaderMod(loader.Module):
    ...
    strings = {
        ...
        "inline_init_failed": (
            ...
            " Premium inline feature and initialization of InlineManager"
    ...
    strings_ru = {
        ...
        "inline_init_failed": (
            ...
            " PremiumInline, а инициализация менеджера инлайна неудачна</b>\n<i>Попробуй"
    ...
    strings_de = {
        ...
        "inline_init_failed": (
            ...
            " Initialisierung von PremiumInline und Inline-Manager"
    ...
    strings_tr = {
        ...
        "inline_init_failed": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Bu modül Premium satır"
        ...
        "version_incompatible": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Bu modül Premium {}"
            " sürümünü gerektirmektedir.+\nLütfen, </b><code>.update</code> kodu ile"
            " Premium'yı güncelleyin"
        ),
        "ffmpeg_required": (
    ...
    strings_uz = {
        ...
        "depends_from": (
            "\n\n<emoji document_id=5431736674147114227>📦</emoji> <b>Bog'liqliklar:"
            "</b>\n{}"
        ),
        "by": "dan",
        "module_fs": (
        ...
        "cannot_unload_lib": (
            "<emoji document_id=5454225457916420314>😖</emoji> <b>Siz kutubxonani olib"
            " tashlay olmaysiz</b>"
        ),
        "wait_channel_approve": (
            "<emoji document_id=5469741319330996757>💫</emoji> <b>Modul"
    ...
    strings_ja = {
        ...
        "inline_init_failed": (
            ...
            "Premium インライン機能と InlineManager の初期化"
    ...
    strings_kr = {
        ...
        "inline_init_failed": (
            ...
            " Premium 인라인 기능 및 InlineManager 초기화"
    ...
    strings_ar = {
        ...
        "inline_init_failed": (
            ...
            " تتطلب وجود Premium inline وفشلت"
    ...
    strings_es = {
        ...
        "inline_init_failed": (
            ...
            " requiere la existencia de Premium inline y falló"
    ...
    async def _send_stats(self, url: str, retry: bool = False):
        """Send anonymous stats to Premium"""
        try:
            ...
            res = await utils.run_sync(
                ...
                data={"url": url},
                headers={"X-Premium-Token": self.get("token")},
            )
    ...
    async def load_module(
        ...
        if re.search(r"# ?scope: ?premium_min", doc):
            ver = re.search(r"# ?scope: ?premium_min ((\d+\.){2}\d+)", doc).group(1)
        ...
        module_name = f"premium.modules.{uid}"
        ...
        try:
            try:
                ...
                async def inner_proxy():
                    ...
                    while True:
                        if hasattr(instance, "premium_wait_channel_approve"):
                            if message:
                                (
                                    module,
                                    channel,
                                    reason,
                                ) = instance.premium_wait_channel_approve
        ...
        instance.premium_meta_pic = next(
            (
        ...
        try:
            if developer in self._client._premium_entity_cache and getattr(
