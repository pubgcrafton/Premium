...
@loader.tds
class PremiumBackupMod(loader.Module):
    ...
    async def client_ready(self):
        ...
        self._backup_channel, _ = await utils.asset_channel(
            ...
            silent=True,
            archive=True,
            avatar="https://siasky.net/FACPLbdZwFG66AvJMNWbuy6xAQ5Zinuo6Ys8alUkmW8z_A",
            _folder="premium",
        )
    ...
    async def handler(self):
        try:
            ...
            backup.name = "premium-db-backup-{}.json".format(
            ...
            logger.exception("PremiumBackup failed")
