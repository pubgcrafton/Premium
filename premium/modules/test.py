...
class TestMod(loader.Module):
    ...
    strings = {
        ...
        "logs_filename": "premium-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>💢</emoji> <b>Premium logs with"
            " verbosity </b><code>{}</code>\n\n<emoji"
            " document_id=5454390891466726015>👋</emoji> <b>Premium version:"
    ...
    strings_ru = {
        ...
        "logs_filename": "premium-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>💢</emoji> <b>Логи Premium уровня"
    ...
    strings_de = {
        ...
        "logs_filename": "premium-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>💢</emoji> <b>Premium-Level-Protokolle"
            " </b><code>{}</code>\n\n<emoji document_id=5454390891466726015>👋</emoji>"
            " <b>Premium-Version: {}.{}.{}</b>{}\n<Emoji"
    ...
    strings_uz = {
        ...
        "logs_filename": "premium-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>💢</emoji> <b>Premium Userbot Jurnallari"
            " </b><code>{}</code>\n\n<emoji document_id=5454390891466726015>👋</emoji>"
            " <b>Premium Userbot versiyasi: {}.{}.{}</b>{}\n<Emoji"
        ...
        "ping_hint": (
            ...
            " faktorlariga bog'liq va Userbot o'rnatilgan serverlarning sozlamalari"
        ...
        "confidential_text": (
            ...
            " bo'lishi mumkin. O'zingizni xavfsizligi uchun</b>\n<b>Yozing"
    ...
    strings_tr = {
        ...
        "logs_filename": "premium-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>💢</emoji> <b>Premium Günlükleri"
            " </b><code>{}</code>\n\n<emoji document_id=5454390891466726015>👋</emoji>"
            " <b>Premium versiyası: {}.{}.{}</b>{}\n<Emoji"
    ...
    strings_hi = {
        ...
        "logs_filename": "premium-logs.txt",
        "logs_caption": (
            "<emoji document_id=5188377234380954537>💢</emoji> <b>Premium लॉग</b>"
            " </code>\n\n<emoji document_id=5454390891466726015>👋</emoji>"
            " <b>Premium संस्करण: {}.{}.{}</b>{}\n<Emoji"
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                " logs from TestModule. If this option is enabled, Premium will send all"
    ...
    @loader.command(
        ...
        uz_doc="Xabarning jurnalini ko'rsatish uchun unga javob bering",
    ...
    @loader.command(
        ...
        uz_doc=(
            "[modul] - Dasturchilar uchun: modulni debug rejimida ochib, uni"
    ...
    @loader.command(
        ...
        uz_doc="<daraja> - Jurnallarni ko'rsatish",
    ...
    async def logs(
        ...
        if btoken := self._db.get("premium.inline", "bot_token", False):
            logs = logs.replace(
                btoken,
                f'{btoken.split(":")[0]}:***************************',
            )

        if premium_token := self._db.get("PremiumDL", "token", False):
            logs = logs.replace(
                premium_token,
                f'{premium_token.split("_")[0]}_********************************',
            )

        if premium_token := self._db.get("Kirito", "token", False):
            logs = logs.replace(
                premium_token,
                f'{premium_token.split("_")[0]}_********************************',
            )
        ...
        if os.environ.get("premium_session"):
            logs = logs.replace(
                os.environ.get("premium_session"),
                "StringSession(**************************)",
            )
        ...
        other = (
            *main.__version__,
            " <i><a"
            f' href="https://github.com/pubgcrafton/Premium/commit/{ghash}">({ghash[:8]})</a></i>'
            if ghash
            else "",
