...
class UpdaterMod(loader.Module):
    ...
    strings = {
        ...
        "update_confirm": (
            "❓ <b>Are you sure you"
            " want to update?\n\n<a"
            ' href="https://github.com/pubgcrafton/Premium/commit/{}">{}</a> ⤑ <a'
    ...
    async def restart_common(
        ...
        msg_obj = await utils.answer(
            ...
            self.strings("restarting_caption").format(
                ...
                if self._client.premium_me.premium
                and CUSTOM_EMOJIS
    ...
    async def _add_folder(self):
        ...
        if any(getattr(folder, "title", None) == "premium" for folder in folders):
            return
