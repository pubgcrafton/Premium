...
class PrivatmtMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "custom_banner",
                "https://raw.githubusercontent.com/pubgcrafton/assets/main/premium_info_2.png",
    ...
    def _render_mt(self) -> str:
        ...
        build = f'<a href="https://github.com/pubgcrafton/Premium/commit/{ver}">#{ver[:8]}</a>'  # fmt: skip
