...
class PremiumInfoMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "custom_button",
                ["💢 Support chat", "https://t.me/shaxsiy_userbot_guruhi"],
            ...
            loader.ConfigValue(
                "banner_url",
                "https://siasky.net/jAAx9TkFTQqpWS_wxcUZ2IhhRSbz9Iom0CCKDms1Rq5Zew",
    ...
    async def client_ready(self):
        ...
        if (
            ...
            == "https://github.com/hikariatama/assets/raw/master/premium_banner.png"
        ):
            self.config[
                "banner_url"
            ] = "https://siasky.net/jAAx9TkFTQqpWS_wxcUZ2IhhRSbz9Iom0CCKDms1Rq5Zew"
    ...
    async def premiuminfocmd(self, message: Message):
        """[en/ru - default en] - Send info aka 'What is Premium?'"""
        ...
        await utils.answer(
            ...
            ' href="https://github.com/pubgcrafton/Remium">GitHub</a>'
            if args == "en"
            else (
                "<emoji document_id=6318565919471699564>🌌</emoji>"
