...
class CoreMod(loader.Module):
    ...
    strings_uz = {
        ...
        "prefix_incorrect": (
            "<emoji document_id=5436162517686557387>🚫</emoji> <b>Prefiks faqat bitta belgidan iborat "
            "bo'lishi kerak</b>"
        ),
        "prefix_set": (
        ...
        "premium": (
            ...
            " <b>Yaratish: </b><i>{}</i>\n\n<emoji"
            " document_id=5233346091725888979>⚙️</emoji> <b>Premium-TL:"
            " </b><i>{}</i>\n\n<emojidocument_id=5454182070156794055>⌨️</emoji>"
            " <b>Ishlab chiquvchi: t.me/DONIYOR_TM</b>"
        ),
        "_cls_doc": "Userbotning asosiy sozlamalarini boshqarish",
        "confirm_cleardb": (
    ...
    @loader.command(
        ru_doc="Показать версию Premium",
        de_doc="Zeige die Premium-Version an",
        tr_doc="Premium sürümünü gösterir",
        uz_doc="Premium Userbot versiyasini ko'rsatish",
        hi_doc="Premium का संस्करण दिखाएं",
        ja_doc="Premiumのバージョンを表示します",
        kr_doc="Premium 버전을 표시합니다",
        ar_doc="إظهار إصدار Premium",
        es_doc="Mostrar la versión de Premium",
    )
    async def premiumcmd(self, message: Message):
        """Get Premium version"""
        await utils.answer(
            message,
            self.strings("premium").format(
                (
                ...
                if self._client.premium_me.premium and CUSTOM_EMOJIS
                else "💢 <b>Premium userbot</b>",
                *version.__version__,
    ...
    @loader.command(
        ...
        uz_doc="Buyruq uchun taxallus belgilash",
    ...
    @loader.command(
        ...
        uz_doc="Buyruq uchun taxallusni o'chirish",
