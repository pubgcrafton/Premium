...
class UpdateNotifierMod(loader.Module):
    """Tracks latest Premium releases, and notifies you, if update is required"""

    strings = {
        "name": "UpdateNotifier",
        "update_required": (
            "💢 <b>Premium Update available!</b>\n\nNew Premium version released.\n🔮"
            " <b>Premium <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 And {} more...</b></i>",
    ...
    strings_ru = {
        "update_required": (
            "💢 <b>Доступно обновление Premium!</b>\n\nОпубликована новая версия Premium.\n🔮"
            " <b>Premium <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 И еще {}...</b></i>",
    ...
    strings_de = {
        "update_required": (
            "💢 <b>Premium Update verfügbar!</b>\n\nNeue Premium Version veröffentlicht.\n🔮"
            " <b>Premium <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 Und {} mehr...</b></i>",
    ...
    strings_uz = {
        "update_required": (
            "💢 <b>Premium Userbot yangilashi mavjud!</b>\n\nPremium Userbotning yangi versiyasi chiqdi.\n🔮"
            " <b>Premium Userbot <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 Va {} boshqa...</b></i>",
        "_cfg_doc_disable_notifications": "Yangilanish xabarlarini o'chirish",
        "latest_disabled": "Yangi yangilanish haqidagi xabarlar o'chirildi",
        "update": "🔄 Yangilash",
    ...
    strings_tr = {
        "update_required": (
            "💢 <b>Premium güncellemesi mevcut!</b>\n\nYeni bir Premium sürümü"
            " yayınlandı.\n🔮 <b>Premium <s>{}</s> -> {}</b>\n\n{}"
        ),
    ...
    strings_ja = {
        "update_required": (
            "💢 <b>Premium の更新があります！</b>\n新しいPremiumバージョンがリリースされました。\n🔮 <b>Premium <s>{}</s> ->"
            " {}</b>\n{}"
        ),
        "more": "\n<i><b>🎥 そして{}も...</b></i>",
    ...
    strings_kr = {
        "update_required": (
            "💢 <b>Premium 업데이트가 있습니다!</b>\n새로운 Premium 버전이 출시되었습니다.\n🔮 <b>Premium <s>{}</s>"
            " -> {}</b>\n{}"
        ),
        "more": "\n<i><b>🎥 그리고 {} 더...</b></i>",
    ...
    strings_ar = {
        "update_required": (
            "💢 <b>يوجد تحديث لـ Premium!</b>\n\nتم إصدار إصدار جديد من Premium.\n🔮"
            " <b>Premium <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 و {} أكثر...</b></i>",
    ...
    strings_es = {
        "update_required": (
            "💢 <b>¡Actualización de Premium disponible!</b>\n\nSe ha publicado una nueva"
            " versión de Premium.\n🔮 <b>Premium <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 Y {} más...</b></i>",
    ...
    async def client_ready(self):
        ...
        self._markup = lambda: self.inline.generate_markup(
            [
                {"text": self.strings("update"), "data": "premium_update"},
                {"text": self.strings("ignore"), "data": "premium_upd_ignore"},
            ]
        )
        ...
        if self._pending not in [utils.get_git_hash(), self._notified]:
            m = await self.inline.bot.send_message(
                ...
                self.strings("update_required").format(
                    ...
                    '<a href="https://github.com/pubgcrafton/Premium/compare/{}...{}">{}</a>'
                    .format(
    ...
    async def update(self, call: InlineCall):
        ...
        if call.data not in {"premium_update", "premium_upd_ignore"}:
            return

        if call.data == "premium_upd_ignore":
