...
from ..log import PremiumException
...
class PythonMod(loader.Module):
    ...
    async def e(self, message: Message):
        ...
        try:
            ...
            item = PremiumException.from_exc_info(*sys.exc_info())
            exc = (
                "\n<b>🪐 Full stack:</b>\n\n"
            ...
            exc = exc.replace(str(self._client.premium_me.phone), "📵")
        ...
        ret = ret.replace(str(self._client.premium_me.phone), "📵")
