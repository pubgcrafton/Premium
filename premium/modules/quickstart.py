...
TEXT = """💢🇬🇧 <b>Hello.</b> You've just installed <b>Premium</b> userbot.
...
TEXT_RU = """🌘🇷🇺 <b>Привет.</b> Твой юзербот <b>Premium</b> установлен.
...
if "RAILWAY" in os.environ:
    TEXT += (
        ...
        " free hours per month</b>. Once this limit is reached, your <b>Premium will be"
...
class QuickstartMod(loader.Module):
    ...
    async def client_ready(self):
        if self._db.get("premium", "disable_quickstart", False):
            raise loader.SelfUnload

        self.mark = (
            lambda lang: [
                [{"text": "🥷 Support", "url": "https://t.me/DONIYOR_TM"}],
                [
                    {
                        "text": "🇷🇺 Изменить язык",
            ...
            if lang == "en"
                ...
                [{"text": "🥷 Помощи", "url": "https://t.me/DONIYOR_TM"}],
                [
                    {
        ...
        self._db.set("premium", "disable_quickstart", True)
