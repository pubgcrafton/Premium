...
class QuickstartMod(loader.Module):
    ...
    strings = {
        "name": "Quickstart",
        "base": """🔰🇬🇧 <b>Hello.</b> You've just installed <b>Premium</b> userbot.
...
💡 <b>Premium supports modules from Friendly-Telegram and GeekTG, as well as its own ones.</b>""",
        "okteto": (
        ...
        "railway": (
            ...
            " <b>Premium will be frozen</b>. Next month <b>you will need to go to"
    ...
    strings_ru = {
        "base": """🔰🇷🇺 <b>Привет.</b> Твой юзербот <b>Premium</b> установлен.
...
💡 <b>Premium поддерживает модули из Friendly-Telegram и GeekTG, а также свои собственные.</b>
""",
        "okteto": (
    ...
    strings_de = {
        "base": """🔰🇩🇪 <b>Hallo.</b> Dein Userbot <b>Premium</b> ist installiert.
...
📣 <b>Schaue dir die Module-Kanäle an, die von der Community erstellt wurden: <a href="https://t.me/shaxsiy_userbot/8">anzeigen</a></b>
...
💡 <b>Premium unterstützt Module von Friendly-Telegram und GeekTG sowie eigene Module.</b>
""",
        "okteto": (
    ...
    strings_uz = {
        "base": """🔰🇺🇿 <b>Salom.</b> <b>Premium</b> Sizning foydalanuvchi botingiz sozlandi.
...
""",
    ...
    strings_tr = {
        "base": """🔰🇹🇷 <b>Merhaba.</b> <b>Premium</b> kullanıcı botunuz kuruldu.
...
💡 <b>Premium Friendly-Telegram ve GeekTG modüllerini de dahil olmak üzere kendi modüllerini destekler.</b>
""",
        "okteto": (
    ...
    strings_hi = {
        "base": """🔰🇮🇳 <b>नमस्ते.</b> आपका <b>Premium</b> उपयोगकर्ता बॉट स्थापित किया गया है.
...
💡 <b>अपने मॉड्यूल को समर्थित करने के लिए, Premium Friendly-Telegram और GeekTG मॉड्यूल भी शामिल हैं.</b>
""",
        "okteto": (
...
💡 <b>モジュールをサポートするには、Premium Friendly-Telegram と GeekTG モジュールも含まれています。</b>
""",
        "okteto": (
...
💡 <b>모듈을 지원하려면 Premium Friendly-Telegram 및 GeekTG 모듈도 포함됩니다.</b>
""",
        "okteto": (
...
💡 <b>لدعم الوحدات، يتضمن Premium Friendly-Telegram و GeekTG أيضًا.</b>
""",
        "okteto": (
...
💡 <b>Para admitir módulos, también incluye Premium Friendly-Telegram y GeekTG.</b>
""",
        "okteto": (
